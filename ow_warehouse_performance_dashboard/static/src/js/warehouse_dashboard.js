...
export class WarehouseOpsCenter extends Component {
    ...
    open(model,domain,name,views){this.action.doAction({type:"ir.actions.act_window",name,res_model:model,views:views||[[false,"tree"],[false,"form"]],domain:domain||[],target:"current"});}
