...
class ModuleUsageDashboard extends Component {
    ...
    async loadData() {
        ...
        try {
            this.state.data = await this.rpc("/module_usage_tracker/dashboard_data", {
    ...
    openLogs(domain = [], title = "Usage Logs") {
        this.action.doAction({
            ...
            views: [[false, "tree"], [false, "graph"], [false, "pivot"], [false, "form"]],
...
ModuleUsageDashboard.template = "module_usage_tracker.Dashboard";
ModuleUsageDashboard.components = { Layout };
